...
export const TaskIcon = ({ scale = 1, color, variant = 'error' }: NotFoundIconProps) => {
  ...
  return (
    <svg
      ...
      style={{
        filter: settings[0].enableGlow ? `drop-shadow(0px 0px ${64 * scale}px ${taskIconClr}c8)` : 'none'
      }}
    >
      <title>Tarea</title>
      <circle cx='130.837' cy='34.2327' r='26.7209' stroke={taskIconClr} stroke-width='14' />
      <rect y='51.7676' width='261' height='381.721' rx='45' fill={taskIconClr} fill-opacity='0.6' />
      <rect x='26.9767' y='80.0928' width='207.047' height='325.07' rx='35' fill='white' fill-opacity='0.9' />
      <rect x='64.7442' y='176.535' width='132.186' height='132.186' rx='66.093' fill={taskIconClr} />
      {renderIcon()}
