...
export const createCustomTheme = (primaryColor: string, backgroundColor = '#232e58', mode: 'light' | 'dark' = 'dark'): Theme => {
  return createTheme({
    components: {
      ...muiComponentsProps
    },
...
export const Themes: { name: string; MuiTheme: Theme }[] = Object.entries(themeConfig).map(([name, config]) => ({
  name: name as string,
